...
## I. Statistics
##### 1. [Point Estimate and Central Limit Theorem](https://github.com/AndonisPavlidis/portfolio/blob/master/statistics/point_estimate_and_clt.ipynb) 
Point estimate. Central Limit Theorem.

##### 2. [Confidence Intervals](https://github.com/AndonisPavlidis/portfolio/blob/master/statistics/confidence_intervals.ipynb) 
Proportion and mean. Difference in proportions and means. Paired data.

##### 3. [Hypothesis Testing](https://github.com/AndonisPavlidis/portfolio/blob/master/statistics/hypothesis_testing.ipynb)
Hypothesis testing using a simulated coin flip.

##### 4. [AB Testing](https://github.com/AndonisPavlidis/portfolio/blob/master/statistics/ab_testing.ipynb)
Set up an AB Test for e-commerce.

##### 5. [Power Analysis](https://github.com/AndonisPavlidis/portfolio/blob/master/statistics/power_analysis.ipynb)
Statistical power. Analytical approach to power analysis.

## II. Machine Learning

### Generalised Linear Models
##### 1. [Poisson Regression](https://github.com/AndonisPavlidis/portfolio/blob/master/machine_learning/poisson_regression.ipynb)
...
##### 2. [Negative Binomial Regression](https://github.com/AndonisPavlidis/portfolio/blob/master/machine_learning/negative_binomial_regression.ipynb)
